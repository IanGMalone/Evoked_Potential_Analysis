...
df = 
  df_neilsen %>% 
  filter(Therapy == "Yes")%>% 
  filter(Side == "Left")%>% # change which side is being compared here
  filter(Metric == "p2p")%>% # change which metric is used here
  filter(Time_Bin == "1_to_21ms")%>%
  filter(Day == 2) # change which day is being compared here

# fit linear mixed effects model comparing slopes (fixed intercept, random slope)
...
df = 
  df_neilsen %>% 
  filter(Injury == "No" & Therapy == "Yes")%>% # change which group is being compared here
  filter(Metric == "p2p")%>% # change which metric is used here
  filter(Time_Bin == "1_to_21ms")%>%
  filter(Day == 3) # change which day is being compared here
